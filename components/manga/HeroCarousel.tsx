...
export default function HeroCarousel({ items, accentStyle }: HeroCarouselProps) {
  ...
  const chapterCount = active.chapters?.length ?? 0;
    ...
    >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 z-10">
                  ...
                  <div className="flex items-center gap-2">
                    <motion.button
                      ...
                      className={cn(
                        "flex items-center gap-1.5 px-5 py-2.5 rounded-full text-white text-xs font-semibold transition-all",
                        accentStyle.bg
                      )}
                    >
                    ...
                    <motion.button
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="flex items-center gap-1.5 px-4 py-2.5 rounded-full bg-white/10 text-white text-xs font-medium backdrop-blur-sm hover:bg-white/15 transition-colors"
                    >
      ...
      {visible.length > 1 && !isPaused && (
        ...
        >
          <motion.div
            className="h-full"
            style={{ background: accentStyle.bg }}
            animate={{ scaleX: [0, 1] }}
            transition={{ duration: 6, ease: "linear" }}
          />
        </motion.div>
