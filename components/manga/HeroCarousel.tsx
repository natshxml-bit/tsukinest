              ...
              <div className="relative h-full w-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 z-20 p-3 sm:p-5">
                  ...
                  <div className="flex items-center gap-2 flex-wrap mb-2">
                    ...
                    {/* CTA — sejajar dengan metadata */}
                    <span className={cn("inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md text-white text-[9px] font-bold ml-auto", accentStyle.bg)}>
