...
// =============================================================================
// HELPERS — Konsisten dengan Explore, Search, Popular
// =============================================================================
...
// =============================================================================
// MANGA CARD — Badge + Flag selaras dengan semua halaman lain
// =============================================================================
...
export default function LatestPage({
  ...
  useEffect(() => {
    ...
    // ✅ FIX: Konek ke /filter?order=latest (bukan /latest yang gak ada)
